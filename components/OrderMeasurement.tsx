  ...
  return (
    <>
      ...
      <div className="modal overflow-y-scroll lg:overflow-auto">
        <div className="modal-box bg-white max-h-min max-w-min mt-[29rem] lg:mt-0">
          ...
          <div className="flex flex-col lg:flex-row p-4 lg:border">
            <div>
                  ...
                  <div className="flex flex-col gap-y-3">
                    <div className="w-40 flex justify-between">
                      ...
                      <input
                        id="chest"
                        type="text"
                        className="input input-bordered w-20 h-8 rounded-none"
                      />
                    </div>
                    <div className="w-40 flex justify-between">
                      <label htmlFor="waist">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between">
                    ...
                    <input
                      id="length2"
                      type="text"
                      className="input input-bordered w-40 h-8 rounded-none"
                    />
                  </div>
                  <div className="flex justify-between">
